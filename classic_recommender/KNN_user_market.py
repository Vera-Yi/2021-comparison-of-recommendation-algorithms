...
class Personal_KNN_recommender:
    def __init__(self, mode=0):
        self.index = pd.read_csv('../data/personal/markets.csv')
        self.reader = Reader()
        self.ratings = pd.read_csv('../data/personal/market_train.csv')
        self.testings = pd.read_csv('../data/personal/market_test.csv')
