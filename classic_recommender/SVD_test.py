...
train_data = pd.read_csv('../data/personal/train.csv')
test_data = pd.read_csv('../data/personal/test.csv')
class SVD:
    ...
    def train(self, steps=30, gamma=0.04, Lambda=0.2):  # 训练函数，step为迭代次数。
