...
test = pd.read_csv('../data/personal/movie_test.csv')
usrid = []
movieid = []
...
print( neg/float(posi + neg),posi / float(posi + neg),len(result['userId'])/(neg+posi+len(data_all)),posi/(neg+posi+len(data_all)))
